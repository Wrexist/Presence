...
Presence/
├── App/
│   ├── PresenceApp.swift          # App entry point
...
│   │   ├── PresentUser.swift      # Active presence model
│   │   ├── Wave.swift             # Wave/connection model
│   │   └── Venue.swift            # Venue classification model
│   ├── Services/
│   │   ├── PresenceService.swift  # Core presence on/off logic
│   │   ├── LocationService.swift  # CoreLocation wrapper
│   │   ├── MatchingService.swift  # AI icebreaker + wave logic
│   │   ├── SocketService.swift    # WebSocket real-time connection
...
├── Features/
│   ├── Onboarding/
│   │   ├── OnboardingView.swift   # Luma-led onboarding
│   │   ├── BioSetupView.swift     # 3-word bio input
│   │   └── OnboardingVM.swift
│   ├── Map/
│   │   ├── MapView.swift          # Main presence map (Liquid Glass)
│   │   ├── PresenceDotView.swift  # Glowing user dot
│   │   ├── VenueCardView.swift    # Glass venue info card
│   │   └── MapViewModel.swift
│   ├── Wave/
│   │   ├── WaveView.swift         # Icebreaker + wave UI
│   │   ├── ChatView.swift         # 10-min timed chat
│   │   └── WaveViewModel.swift
│   ├── Profile/
│   │   ├── ProfileView.swift
...
│
├── DesignSystem/
│   ├── GlassTokens.swift          # ALL glass constants — use these
│   ├── GlassComponents.swift      # Reusable glass components
│   ├── PresenceColors.swift       # Brand color palette
│   ├── Typography.swift           # Type scale
│   └── Luma/
│       ├── LumaView.swift         # Mascot display component
│       ├── LumaAnimations.swift   # Lottie animation keys
│       └── LumaState.swift        # Mascot emotional states
│
├── Backend/                       # Node.js backend (separate target)
│   ├── src/
│   │   ├── routes/
│   │   ├── services/
│   │   │   ├── presenceService.ts
│   │   │   ├── matchingService.ts  # Claude API calls
...
4. Check git status — understand current branch and uncommitted state
5. Do NOT begin coding until you understand the context
